...
public void roll(int pins) {
	...
	// handling Exception (analysis pins value) 
	if (!lastround) {
...
// actions in all frame/round
	...
	if (previousframe!=null) {
		if (previousframe.bonuses>0 ) {
			...
			System.out.print("Runda:"+frame_nb+";rzut:"+roll_nb+" Bonusy"+previousframe.bonuses+" roundy Score="+this.calculateScore()+"\n");
...
// Extra control in the last round. Correcting actions.
	...
	//	System.out.print("Koniec rundy:"+frame_nb+";rzut:"+roll_nb+" Bonusy"+bonuses+"; Score="+this.calculateScore()+"\n");
