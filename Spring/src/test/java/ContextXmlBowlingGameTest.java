...
public class ContextXmlBowlingGameTest {
	static int MAX = 21;
...
//	private ApplicationContext context; 
	...
	private BowlingGame bowlingUnderTest; 
	...
	@Before public void initializeBowlingGameTests() {
		...
		context = new ClassPathXmlApplicationContext("standardcontext.xml");	
		bowlingUnderTest = context.getBean(BowlingGame.class);
